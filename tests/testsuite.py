...
class Workspace(object):
  ...
  def __init__(self):
    ...
    self.examples_dir = os.path.join(self.root_dir,"../Ananke/examples")
    self.examples = []
    self.tests = []
    if not os.path.isdir("../Ananke"):
      raise Exception("Cannot find Ananke library")
    try:
      import ino
    except:
  ...
  def init(self):
    ...
    shutil.copytree("../../Ananke","lib/Ananke")
